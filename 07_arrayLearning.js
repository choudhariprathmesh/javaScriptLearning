...
// console.log(`Travasing  revarse array using for loop`);
...
// console.log(`even element print using for loop`);
// for (let index = 0; index < arrayOfNumbers.length; index++) {
//     if (index%2==0) {
//         const element = arrayOfNumbers[index];
//         console.log(element);        
...
// arrayOfNum.push(3);   // adding element at last 
// console.log(arrayOfNum);
...
// var arrayOfNum = [4, 5, 6, 8, 9, 1];
// console.log(arrayOfNum);
// arrayOfNum.unshift(77); // add element in first
// arrayOfNum.unshift(99, 111, 333);
// console.log(arrayOfNum);

// console.log(`======== pop() methods=========`);
// var arrayOfNum = [4, 5, 6, 8, 9, 33];
// let popResult = arrayOfNum.pop();  //deleating element from last
// console.log(popResult);
// console.log(arrayOfNum);

// console.log(`======== shift() methods=========`);
// var arrayOfNum = [4, 5, 6, 8, 9, 33];
// let shiftResult = arrayOfNum.shift(); // deleating element from first
...
// let sliceRes = arrayOfNum.slice(2, 5);  // return select index
// console.log(arrayOfNum);
